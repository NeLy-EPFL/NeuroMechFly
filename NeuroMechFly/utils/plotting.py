...
def plot_data(
    ...
    Parameters:
        ...
        joint_key (str): Key for specifying a joint to plot (angles_sim, torques_muscles, muscles_act), e.g, Coxa, Femur, Tibia, Tarsus
        ...
        plot_angles_sim (bool, default False): Plotting angles from simulation
        plot_angles (bool, default True): Plotting angles from external source and defined in variable angles
...
def plot_fly_path(
    ...
    Parameters:
        path_data (str): Path to data for plotting
        generations (list): Numbers of the generations to plot
