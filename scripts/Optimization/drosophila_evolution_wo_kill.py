...
class DrosophilaEvolution(FloatProblem):
    ...
    def __init__(self):
        ...
        lower_bound_active_muscles = (
                np.asarray(
                    [# Front
                    [-2.0, -2.0, -3.0, -4.0, -0.22], # Coxa
                    [-2.0, -2.0, -3.0, -4.0, -2.5], # Femur
                    [-2.0, -2.0, -3.0, -3.3, 0.76], # Tibia
                    # Mid
                    [-2.0, -2.0, -3.0, -4.0, -2.2], # Coxa_roll
                    [-2.0, -2.0, -3.0, -4.0, -2.35], # Femur
                    [-2.0, -2.0, -3.0, -3.3, 1.73], # Tibia
                    # Hind
                    [-2.0, -2.0, -3.0, -4.0, -2.78], # Coxa_roll
                    [-2.0, -2.0, -3.0, -4.0, -2.46], # Femur
                    [-2.0, -2.0, -3.0, -3.3, 1.12], # Tibia
                    ]
                )
        ).flatten()
        ...
        upper_bound_active_muscles = (
                np.asarray(
                    [
                    # Front
                    [0.0, 0.0, 0.0, -3.0, 0.49], # Coxa
                    [0.0, 0.0, 0.0, -3.0, -1.3], # Femur
                    [-1.0, -1.0, -1.0, -3.0, 2.19], # Tibia
                    # Mid
                    [0.0, 0.0, 0.0, -3.0, -1.75], # Coxa_roll
                    [0.0, 0.0, 0.0, -3.0, -1.84], # Femur
                    [-1.0, -1.0, -1.0, -3.0, 2.63], # Tibia
                    # Hind
                    [0.0, 0.0, 0.0, -3.0, -2.44], # Coxa_roll
                    [0.0, 0.0, 0.0, -3.0, -1.31], # Femur
                    [-1.0, -1.0, -1.0, -3.0, 2.79], # Tibia
                    ]
                )
        ).flatten()
